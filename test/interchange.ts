...
describe('Name to SKU', () => {
	...
	it('Case #5', () => {
		const name =
			'Strange Professional Killstreak Festivized Australium Medi Gun';
	...
	it('Case #7', () => {
		const name =
			'Professional Killstreak Strange Silver Botkiller Sniper Rifle Mk.I';
...
describe('Econ to SKU', () => {
	...
	it('Case #6 - with true defindex', () => {
		...
		assert.equal(sku, '15005;5;u703;w2;pk9;kt-2;festive');
	});

	it('Case #7 - with true defindex', () => {
		const econ = {
			appid: 440,
			contextid: '2',
			assetid: '8656785508',
		...
		assert.equal(sku, '15006;15;w3;pk6;kt-2;festive');
	});
});
...
describe('SKU to Name', () => {
	...
	it('Case #4', () => {
		...
		assert.equal(
			name,
			'Non-Craftable Professional Killstreak Sniper Rifle Kit'
		);
	});
	...
	it('Case #7', () => {
		...
		assert.equal(
			name,
			'Strange Professional Killstreak Silver Botkiller Sniper Rifle Mk.I'
		);
	});
});
...
describe('SKU to Listing', () => {
	...
	it('Case #7', () => {
		...
		assert.deepEqual(listing, {
			...
			craftable: 1,
			item_name:
				'Professional Killstreak Silver Botkiller Sniper Rifle Mk.I',
			priceindex: 0,
		});
	});
});

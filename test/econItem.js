...
describe('parseEconItem', () => {
		...
		const econItem = parseEconItem(
			{
				...
				descriptions: [
					...
					{
						value: '★ Unusual Effect: Haunted Kraken',
						color: 'ffd700',
					},
					{
						value: '',
					...
					{
						value: '    The Surgical Survivalist',
						color: '4b69ff',
						app_data: {
							def_index: '30773',
						},
	...
	it('Case #23', () => {
		const econItem = parseEconItem(
			{
				...
				descriptions: [
					...
					{
						type: 'text',
						value: '★ Unusual Effect: Midnight Whirlwind',
						color: 'ffd700',
						name: 'attribute',
					},
					{
				...
				actions: [
					...
					{
						link: 'steam://rungame/440/76561202255233023/+tf_econ_item_preview%20S%owner_steamid%A%assetid%D14257105530670659053',
						name: 'Inspect in Game...',
					},
				],
				name: 'Strange Unusual Taunt: Burstchester',
				name_color: '8650AC',
				type: 'Strange Special Taunt - Times Performed: 0',
				market_name: 'Strange Unusual Taunt: Burstchester',
				market_hash_name: 'Strange Unusual Taunt: Burstchester',
				market_actions: [
					{
						link: 'steam://rungame/440/76561202255233023/+tf_econ_item_preview%20M%listingid%A%assetid%D14257105530670659053',
						name: 'Inspect in Game...',
					},
				],
				commodity: false,
		...
		assert.deepEqual(econItem, {
			...
			fullName: 'Strange Midnight Whirlwind Taunt: Burstchester',
			id: '15381199923',
			img: 'https://steamcommunity-a.akamaihd.net/economy/image/fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEfbRIfSSTgrSpQnMvuCOGYDfI_l9sn4pUb2zdpyFUiN-LgZ29mIF2XBPYLWfdorAntWiJiupEwVoXv9eJQegjp55yGbeexEq8o_Q/',
			tradable: true,
			craftable: true,
			quality: 'Unusual',
			elevated: true,
			effect: 'Midnight Whirlwind',
			level: -1,
			classes: [
				'Scout',
				'Sniper',
			...
			type: 'taunt',
			collection: 'Confidential Collection',
			grade: 'Assassin',
			parts: [],
			spells: [],
			marketable: true,
	...
	it('Case #24', () => {
		const econItem = parseEconItem(
			{
				...
				background_color: '3C352E',
				icon_url:
					'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPffhYm9YexDHDPIODMot8Qn-W2lq7p4zBtLur-4HLQrpt4rFNeUpMNgYFsLQCafVYVz-uRk-haUJfZffvmqxirizjkA-',
				icon_url_large:
					'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPffhYm9YexDHDPIODMot8Qn-W2lq7p4zBtLur-4HLQrpt4rFNeUpMNgYFsLQCafVYVz-uRk-haUJfZffvmqxirizjkA-',
				descriptions: [
					{
						type: 'text',
						value: 'Mercenary Grade Scattergun (Minimal Wear)',
						color: '4b69ff',
						name: 'attribute',
					},
					{
					...
					{
						type: 'text',
						value: '\nGift from: Alex_Utenov',
						color: '7ea9d1',
						name: 'attribute',
					},
					{
						type: 'text',
						value: 'Date Received: Friday, April 18, 2025 (19:02:48) GMT',
						name: 'attribute',
					},
					{
						type: 'text',
					...
					{
						type: 'text',
						value: 'Scream Fortress XVI Collection',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Broken Record War Paint',
						color: 'eb4b4b',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Necropolish War Paint',
						color: 'd32ce6',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Stardust War Paint',
						color: 'd32ce6',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Stealth Specialist War Paint',
						color: '8847ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Piranha Mania War Paint',
						color: '8847ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Graphite Gripped War Paint',
						color: '8847ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Team Detail War Paint',
						color: '4b69ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Gobi Glazed War Paint',
						color: '4b69ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Sleek Greek War Paint',
						color: '4b69ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '★ Team Charged War Paint',
						color: '4b69ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: "    Brawler's Iron War Paint",
						color: '4b69ff',
						name: 'attribute',
					},
					{
						type: 'text',
						value: '    Blackout War Paint',
						color: '4b69ff',
						name: 'attribute',
					},
				],
				...
				actions: [
					{
						link: 'http://wiki.teamfortress.com/scripts/itemredirect.php?id=200&lang=en_US',
						name: 'Item Wiki Page...',
					},
					{
						link: 'steam://rungame/440/76561202255233023/+tf_econ_item_preview%20S%owner_steamid%A%assetid%D9856136908504052328',
						name: 'Inspect in Game...',
					},
				],
				name: 'Team Charged Scattergun',
				name_color: '8650AC',
				type: '',
				market_name:
					'Strange Unusual Team Charged Scattergun (Minimal Wear)',
				market_hash_name:
					'Strange Unusual Team Charged Scattergun (Minimal Wear)',
				market_actions: [
					{
						link: 'steam://rungame/440/76561202255233023/+tf_econ_item_preview%20M%listingid%A%assetid%D9856136908504052328',
						name: 'Inspect in Game...',
					},
				],
				commodity: false,
		...
		assert.deepEqual(econItem, {
			name: 'Scattergun',
			fullName: 'Strange Isotope Team Charged Scattergun (Minimal Wear)',
			id: '16316540586',
			img: 'https://steamcommunity-a.akamaihd.net/economy/image/fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPffhYm9YexDHDPIODMot8Qn-W2lq7p4zBtLur-4HLQrpt4rFNeUpMNgYFsLQCafVYVz-uRk-haUJfZffvmqxirizjkA-/',
			tradable: true,
			craftable: true,
			quality: 'Unusual',
			texture: 'Team Charged',
			wear: 'Minimal Wear',
			elevated: true,
			effect: 'Isotope',
			level: -1,
	...
	describe('Retrieves crate number', () => {
		...
		it('', () => {
			const econItem = parseEconItem({
				appid: 440,
				classid: '2569815294',
				instanceid: '1096263353',
				currency: 0,
				background_color: '3C352E',
				icon_url:
					'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEbbQ4fSRDrrAdBncbiAfezWLI_l9sn4pUb32c9xFV9ZufhMWIxIgDGVvEPC_Q_owy1XHJm7pA7DYTgrukFfV65sZyGbedogsZa1A',
				icon_url_large:
					'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEbbQ4fSRDrrAdBncbiAfezWLI_l9sn4pUb32c9xFV9ZufhMWIxIgDGVvEPC_Q_owy1XHJm7pA7DYTgrukFfV65sZyGbedogsZa1A',
				descriptions: [
					{
						value: 'A Freelance Grade or better War Paint from the Contract Campaigner Collection',
					},
					{
						value: ' ',
					},
					{
						value: 'This keyless case contains one of the following items:',
					},
					{
						value: '    Bovine Blazemaker Mk.II War Paint',
						color: '8847ff',
					},
					{
						value: '    Dead Reckoner Mk.II War Paint',
						color: '8847ff',
					},
					{
						value: '    Masked Mender Mk.II War Paint',
						color: '4b69ff',
					},
					{
						value: '    Backwoods Boomstick Mk.II War Paint',
						color: '4b69ff',
					},
					{
						value: '    Iron Wood Mk.II War Paint',
						color: '5e98d9',
					},
					{
						value: '    Macabre Web Mk.II War Paint',
						color: '5e98d9',
					},
					{
						value: '',
				...
				actions: [
					{
						link: 'http://wiki.teamfortress.com/scripts/itemredirect.php?id=18004&lang=en_US',
						name: 'Item Wiki Page...',
					},
				],
			...
			assert.deepEqual(econItem, {
				...
				img: 'https://steamcommunity-a.akamaihd.net/economy/image/fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEbbQ4fSRDrrAdBncbiAfezWLI_l9sn4pUb32c9xFV9ZufhMWIxIgDGVvEPC_Q_owy1XHJm7pA7DYTgrukFfV65sZyGbedogsZa1A/',
			});
		});
	});
});

...
describe('parseEconItem', () => {
	it('Case #1', () => {
		const econItem = parseEconItem({
			...
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPffsDz5zdwmTVPAOCcot8Qn-Wxg07dR3XcGzub5ffwvmttSXYrAlY9xFTMaCUvbXNQz_6EkwiPRYKJaIon-9jHjrOWoUG0280KDki-w',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPffsDz5zdwmTVPAOCcot8Qn-Wxg07dR3XcGzub5ffwvmttSXYrAlY9xFTMaCUvbXNQz_6EkwiPRYKJaIon-9jHjrOWoUG0280KDki-w',
			descriptions: [{
				value: 'Mercenary Grade Flame Thrower (Minimal Wear)', color: '4b69ff',
			}, { value: '★ Unusual Effect: Cool', color: 'ffd700' }, { value: 'Festivized', color: 'ffd700' }, {
				value: 'Extinguishing teammates restores 20 health', color: '7ea9d1',
			...
			}, { value: ' ' }, { value: ' ' }, { value: 'Concealed Killer Collection' }, {
				...
				value: '    Sudden Flurry Stickybomb Launcher', color: 'd32ce6',
			}, { value: '    Night Terror Scattergun', color: '8847ff' }, {
				value: '    Carpet Bomber Stickybomb Launcher', color: '8847ff',
			}, {
			...
			name_color: '8650AC',
			type: '',
			market_name: 'Unusual Festivized Specialized Killstreak Forest Fire Flame Thrower (Minimal Wear)',
			market_hash_name: 'Unusual Festivized Specialized Killstreak Forest Fire Flame Thrower (Minimal Wear)',
			market_actions: [{
	...
	it('Case #2', () => {
		const econItem = parseEconItem({
			...
			currency: 0,
			background_color: '3C352E',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEJeQQaWA_dtDlRj82oVPeJUbRTyohkssUGjDBox1IsNrKxaWc1JFWQWPYHDKFsow2_WyVlv4lzWtBtJvRLsg',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEJeQQaWA_dtDlRj82oVPeJUbRTyohkssUGjDBox1IsNrKxaWc1JFWQWPYHDKFsow2_WyVlv4lzWtBtJvRLsg',
			descriptions: [{
	...
	it('Case #3', () => {
		const econItem = parseEconItem({
			...
			currency: 0,
			background_color: '3C352E',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEDewlDDUq7hytIncTqD-CJGu8_l9sn4pUbi2Ftw1ApbbXtNmM_cVTEV_lbWaw7pQu0W3Rr6sVlAdPvoOhScFnt4pyGbefmPm6lTg',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEDewlDDUq7hytIncTqD-CJGu8_l9sn4pUbi2Ftw1ApbbXtNmM_cVTEV_lbWaw7pQu0W3Rr6sVlAdPvoOhScFnt4pyGbefmPm6lTg',
			descriptions: [{ value: 'Commando Grade Hat', color: '8847ff' }, {
				value: '★ Unusual Effect: Twisted Radiance', color: 'ffd700',
			}, { value: ' ' }, { value: ' ' }, { value: 'Spooky Spoils Collection' }, {
	...
	it('Case #4', () => {
		const econItem = parseEconItem({
			...
			currency: 0,
			background_color: '3C352E',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEbfgYfXh7wqwdTmsHiCM2ACfIHnpRh5MkG3G8zyVMpYebiYm8wdFGTBPILC_BvrQu9X3RqupQ6AYPhp-wHZ0yx43BgcxIX',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEbfgYfXh7wqwdTmsHiCM2ACfIHnpRh5MkG3G8zyVMpYebiYm8wdFGTBPILC_BvrQu9X3RqupQ6AYPhp-wHZ0yx43BgcxIX',
	...
	it('Case #5', () => {
		const econItem = parseEconItem({
			...
			descriptions: [{
				value: 'Commando Grade Rocket Launcher (Field-Tested)', color: '8847ff',
			}, { value: 'Festivized', color: 'ffd700' }, {
				value: 'Halloween: Pumpkin Bombs (spell only active during event)', color: '7ea9d1',
			}, { value: 'Sheen: Agonizing Emerald', color: '7ea9d1' }, {
				value: 'Killstreaks Active', color: '7ea9d1',
			}, {
				value: '\nGift from: VLaDOS | S>C.MOON YELLOW BELT', color: '7ea9d1',
			}, {
	...
	it('Case #6', () => {
		const econItem = parseEconItem({
			...
			currency: 0,
			background_color: '3C352E',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEDe1VBDEjdqCEX2PfnGOaDBeEUlNQK6ZFH3jMlwwB_Y7vhZ2Q0JFKQAKQJXadrpF6-UXE268I3UNHg8esHfF28tdHHO65sbo88eQy8bA',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEDe1VBDEjdqCEX2PfnGOaDBeEUlNQK6ZFH3jMlwwB_Y7vhZ2Q0JFKQAKQJXadrpF6-UXE268I3UNHg8esHfF28tdHHO65sbo88eQy8bA',
			descriptions: [{
				value: 'Holiday Restriction: Halloween / Full Moon', color: 'd83636',
			}, {
				value: 'Halloween: Spectral Spectrum (spell only active during event)', color: '7ea9d1',
			}, { value: '' }],
			tradable: 1,
			actions: [{
	...
	it('Case #7', () => {
		const econItem = parseEconItem({
			...
			currency: 0,
			background_color: '3C352E',
			icon_url: 'IzMF03bi9WpSBq-S-ekoE33L-iLqGFHVaU25ZzQNQcXdEH9myp0erksICfTcePMQFc1nqWSMU5OD2NwOx3sIyShXOjLx2Sk5MbUqMcbBnQz4ruyeU2DgVzPLKCnYCGFgGOIYfAeFr3HysPORE2vPELl_RQEMdaFX9GxObM-BOEE_goVdrTXqlBwkHRNxJ5VFcVbihGQdNlNSNRp3',
			icon_url_large: 'IzMF03bi9WpSBq-S-ekoE33L-iLqGFHVaU25ZzQNQcXdEH9myp0erksICfTcePMQFc1nqWSMU5OD2NwOx3sIyShXOjLx2Sk5MbUqMcbBnQz4ruyeU2DgVzPLKCnYCGFgGOIYfAeFr3HysPORE2vPELl_RQEMdaFX9GxObM-BOEE_goVdrTXqlBwkHRNxJ5VFcVbihGQdNlNSNRp3',
			descriptions: [{
				value: 'Paint Color: Noble Hatter\'s Violet', color: '756b5e',
			}, {
				value: 'Halloween: Spectral Spectrum (spell only active during event)', color: '7ea9d1',
			}, {
	...
	it('Case #8', () => {
		const econItem = parseEconItem({
			...
			descriptions: [{ value: 'Style: Tie', color: '756b5e' }, {
				value: 'Halloween: Chromatic Corruption (spell only active during event)', color: '7ea9d1',
			}, {
				value: 'Halloween: Voices From Below (spell only active during event)', color: '7ea9d1',
			}, {
	...
	it('Case #9', () => {
		const econItem = parseEconItem({
			...
			currency: 0,
			background_color: '3C352E',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEYYwsVVB7whyJMhcrvCM2ACfIHnpRi4cBQjGc6xAQjNbuwYGMwJlfHWfAMDaRjpQm6CCVhsZJhUIW3r-9TZ0yx4-owIvoI',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEYYwsVVB7whyJMhcrvCM2ACfIHnpRi4cBQjGc6xAQjNbuwYGMwJlfHWfAMDaRjpQm6CCVhsZJhUIW3r-9TZ0yx4-owIvoI',
			descriptions: [{
	...
	it('Case #10', () => {
		const econItem = parseEconItem({
			...
			descriptions: [{
				value: 'Holiday Restriction: Halloween / Full Moon', color: '756b5e',
			}, { value: '\'\'★ Unusual Effect: Burning Flames\'\'' }, { value: '\'\'★ Unusual Effect: Burning Flames\'\'' }],
			tradable: 1,
			actions: [{
				link: 'http://wiki.teamfortress.com/scripts/itemredirect.php?id=5618&lang=en_US',
				name: 'Item Wiki Page...',
	...
	it('Case #11', () => {
		const econItem = parseEconItem({
			...
			descriptions: [{
				...
				value: 'On Hit: Gain up to +3 health', color: '7ea9d1',
			}, {
				value: '-2 health drained per second on wearer', color: 'd83636',
			}],
			actions: [{
				name: 'Item Wiki Page...',
			...
			tags: [{
				...
				internal_name: 'primary', name: 'Primary weapon', category: 'Type', category_name: 'Type',
			}, {
				internal_name: 'Medic', name: 'Medic', category: 'Class', category_name: 'Class',
			}],
			app_data: {
				def_index: '36', quality: '11',
			},
		}, false, false);
	...
	it('Case #12', () => {
		const econItem = parseEconItem({
			...
			market_marketable_restriction: '0',
			descriptions: [{
				value: 'Assassin Grade Rocket Launcher (Battle Scarred)', color: 'd32ce6',
			}, {
				value: 'Strange Stat Clock Attached', color: 'CF6A32',
			}, {
				value: '     Kills: 5121', color: '756b5e',
			}, {
				...
				value: 'Sheen: Mean Green', color: '7ea9d1',
			}, {
				value: 'Killstreaks Active', color: '7ea9d1',
			}, {
				value: ' ',
				...
				value: '    Liquid Asset Stickybomb Launcher', color: 'eb4b4b', app_data: {
					def_index: '15045',
				},
			}, {
				value: '    Thunderbolt Sniper Rifle', color: 'eb4b4b', app_data: {
					def_index: '15059',
				},
			}, {
				value: '    Current Event Scattergun', color: 'd32ce6', app_data: {
					def_index: '15053',
				},
			}, {
				value: '    Pink Elephant Stickybomb Launcher', color: 'd32ce6', app_data: {
					def_index: '15048',
				},
			}, {
				value: '✔ Shell Shocker Rocket Launcher', color: 'd32ce6', app_data: {
					def_index: '15052',
				},
			}, {
				value: '    Flash Fryer Flame Thrower', color: '8847ff', app_data: {
					def_index: '15049',
				},
			}, {
				value: '    Spark of Life Medi Gun', color: '8847ff', app_data: {
					def_index: '15050',
				},
			}, {
				value: '    Dead Reckoner Revolver', color: '8847ff', app_data: {
					def_index: '15051',
				},
			}, {
				value: '    Black Dahlia Pistol', color: '8847ff', app_data: {
					def_index: '15046',
				},
			}, {
				value: '    Sandstone Special Pistol', color: '8847ff', app_data: {
					def_index: '15056',
				},
			}, {
				value: '    Brick House Minigun', color: '4b69ff', app_data: {
					def_index: '15055',
				},
			}, {
				value: '    Aqua Marine Rocket Launcher', color: '4b69ff', app_data: {
					def_index: '15057',
				},
			}, {
				value: '    Low Profile SMG', color: '4b69ff', app_data: {
					def_index: '15058',
				},
			}, {
				value: '    Turbine Torcher Flame Thrower', color: '4b69ff', app_data: {
					def_index: '15054',
				},
			}, {
				value: '    Lightning Rod Shotgun', color: '4b69ff', app_data: {
					def_index: '15047',
				},
			}],
			actions: [{
			...
			tags: [{
				...
				internal_name: 'Soldier', name: 'Soldier', category: 'Class', category_name: 'Class',
			}, {
	...
	it('Case #13', () => {
		const econItem = parseEconItem({
			...
			classid: '1348131292',
			instanceid: '93028938',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEIUwADWBXjvD1Pid3oDvqJGt8Yltsm2pxUyzFu31V9NbPtYTUwdwWbBfkOXfZioFDuWSFku8JnUdLg8ulQLw29tYfCMOQycIYbhNRIXDY',
			...
			market_hash_name: 'Strange Professional Killstreak Festive Grenade Launcher',
			market_name: 'Strange Professional Killstreak Festive Grenade Launcher',
			name_color: 'CF6A32',
			background_color: '3C352E',
			...
			market_tradable_restriction: '7',
			market_marketable_restriction: '0',
			descriptions: [{ value: '(Airborne Enemy Kills: 4)', color: '756b5e' }, {
			...
			tags: [{
				...
				internal_name: 'Demoman', name: 'Demoman', category: 'Class', category_name: 'Class',
			}],
	...
	it('Case #14', () => {
		const econItem = parseEconItem({
			...
			classid: '1342604629',
			instanceid: '98275077',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgENYwUuWCT1qj1Ni8DZCv2ADN8Mmsgy4N4Hi2JtxQMtbOftYG9hJgabUaYMCvFroV_uDXBkv8EwVY_koOxWeQq-qsKYZPpiOaow',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgENYwUuWCT1qj1Ni8DZCv2ADN8Mmsgy4N4Hi2JtxQMtbOftYG9hJgabUaYMCvFroV_uDXBkv8EwVY_koOxWeQq-qsKYZPpiOaow',
			icon_drag_url: '',
			name: 'Strange Specialized Killstreak Gold Botkiller Wrench Mk.II',
			market_hash_name: 'Strange Specialized Killstreak Gold Botkiller Wrench Mk.II',
			market_name: 'Strange Specialized Killstreak Gold Botkiller Wrench Mk.II',
			name_color: 'CF6A32',
			background_color: '3C352E',
			...
			descriptions: [{ value: '(Kills: 1)', color: '756b5e' }, {
				value: '(Cloaked Spies Killed: 0)', color: '756b5e',
			}, { value: 'Sheen: Deadly Daffodil', color: '7ea9d1' }, { value: 'Killstreaks Active', color: '7ea9d1' }, {
			...
			tags: [{
				...
				internal_name: 'melee', name: 'Melee weapon', category: 'Type', category_name: 'Type',
			}, {
				internal_name: 'Engineer', name: 'Engineer', category: 'Class', category_name: 'Class',
			}],
	...
	it('Case #15', () => {
		const econItem = parseEconItem({
			...
			classid: '11042149',
			instanceid: '19201223',
			icon_url: 'IzMF03bi9WpSBq-S-ekoE33L-iLqGFHVaU25ZzQNQcXdEH9myp0erksICfTdcfMQEpRnqWSMU5OD2NoHwHEIkChXOjLx2Sk5MbUqMcbBnQz4ruyeU3n5awjJLjLaE0pXEvYaYzGdkW_0p7rBXG6aQb0rFl9XK_QM8jdIb82PaURv3dUMrT27kxUqSU5_IZIXcl_smSJdIbMiwRlwHyU',
			icon_url_large: 'IzMF03bi9WpSBq-S-ekoE33L-iLqGFHVaU25ZzQNQcXdEH9myp0erksICfTdcfMQEpRnqWSMU5OD2NoHwHEIkChXOjLx2Sk5MbUqMcbBnQz4ruyeU3n5awjJLjLaE0pXEvYaYzGdkW_0p7rBXG6aQb0rFl9XK_QM8jdIb82PaURv3dUMrT27kxUqSU5_IZIXcl_smSJdIbMiwRlwHyU',
			icon_drag_url: '',
			...
			market_marketable_restriction: '0',
			descriptions: [{
				value: 'Paint Color: Operator\'s Overalls', color: '756b5e',
			}, { value: '' }],
			actions: [{
				name: 'Item Wiki Page...',
			...
			tags: [{
				internal_name: 'Unique', name: 'Unique', category: 'Quality', color: '7D6D00', category_name: 'Quality',
			}, {
				internal_name: 'misc', name: 'Cosmetic', category: 'Type', category_name: 'Type',
			}, {
				internal_name: 'Scout', name: 'Scout', category: 'Class', category_name: 'Class',
			}],
	...
	it('Case #16', () => {
		const econItem = parseEconItem({
			...
			amount: 1,
			missing: false,
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEOYgAYUx7nqgdBidroHuaDGu0FieUmtcFq1Td5lgQ1ZrPtZW5jJ1CaUKMOC_Zr9Vi4XnE36cQxDIXl9e9WeArptNSSMrUvNcYMQZftGxgDiQ',
			...
			fraudwarnings: [],
			descriptions: [{
				type: 'text', value: 'Style: Bugscreen Up', color: '756b5e', app_data: '',
			}, {
				type: 'text',
			...
			app_data: {
				def_index: '988', quality: '6', slot: 'Cosmetic', filter_data: {
					931505789: {
						element_ids: {
							0: '991457757', 1: '8',
						},
	...
	it('Case #18', () => {
		const econItem = parseEconItem({
			...
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEIfgYFWCTxrCpChs_jMuWJCfAPlckK6ZFH3jMlx1kpYbHgNTYyKgGUVPdbCfM_rAm0WiRguJYxBtGzruxReQ3ntoLBZa5sbo_yPNmUMw',
			...
			market_tradable_restriction: '7',
			market_marketable_restriction: '0',
			descriptions: [{ value: 'Crate Series #103', color: '7ea9d1' }, {
				...
				value: '    The Iron Bomber', color: '6F6A63', app_data: { def_index: '1151' },
			}, {
				value: '    The Panic Attack', color: '6F6A63', app_data: { def_index: '1153' },
			}, {
				value: '    The Back Scatter', color: '6F6A63', app_data: { def_index: '1103' },
			}, {
				value: '    The Quickiebomb Launcher', color: '6F6A63', app_data: { def_index: '1150' },
			}, {
				value: '    The Ambassador', color: '6F6A63', app_data: { def_index: '61' },
			}, {
				value: '    The Reserve Shooter', color: '6F6A63', app_data: { def_index: '415' },
			}, {
				value: '    The Degreaser', color: '6F6A63', app_data: { def_index: '215' },
			}, {
				value: '    The Powerjack', color: '6F6A63', app_data: { def_index: '214' },
			}, {
				value: '    Natascha', color: '6F6A63', app_data: { def_index: '41' },
			}, {
				value: '    The Sandvich', color: '6F6A63', app_data: { def_index: '42' },
			}, {
				value: '    Strange Part: Damage Dealt', color: '6F6A63', app_data: { def_index: '6056' },
			}, {
				value: '    Strange Part: Allied Healing Done', color: '6F6A63', app_data: { def_index: '6058' },
			}, {
				value: '    Strange Part: Critical Kills', color: '6F6A63', app_data: { def_index: '6021' },
			}, {
				value: '    Strange Part: Pyros Killed', color: '6F6A63', app_data: { def_index: '6006' },
			}, {
				value: '    Strange Part: Heavies Killed', color: '6F6A63', app_data: { def_index: '6000' },
			}, {
				value: 'or an Exceedingly Rare Special Item!', color: '7ea9d1',
			}],
			actions: [{
				name: 'Item Wiki Page...',
			...
			tags: [{
				...
				internal_name: 'Supply Crate', name: 'Crate', category: 'Type', category_name: 'Type',
			}],
	...
	it('Case #20', () => {
		const econItem = parseEconItem({
			...
			classid: '11123436',
			instanceid: '11040559',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEGaQMQUSTuuSpEjYa_X6fbCbJVn9tht8BU2zNoxwQrZ-bmaGIwdgLHWKFbC_Y4pl3uDSQzptdtU17jE20T',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEGaQMQUSTuuSpEjYa_X6fbCbJVn9tht8BU2zNoxwQrZ-bmaGIwdgLHWKFbC_Y4pl3uDSQzptdtU17jE20T',
			icon_drag_url: '',
	...
	it('Case #19', () => {
		const econItem = parseEconItem({
			...
			classid: '4657007866',
			instanceid: '0',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEYYQ4CThbjqwcR2Jq3MvGNG-U_l9sn4pUbjjc5xAUjMOfnaGNiKwKVA_IIBPRr8lm1XHEzvMY2DIG3rr9eewnns5yGbeenE9nBew',
			...
			descriptions: [{
				...
				value: 'Contents may be Strange or an Unusual Winter 2021 Hat', color: '7ea9d1',
			}, { value: ' ' }, { value: ' ' }, { value: 'Winter 2021 Cosmetics Collection' }, {
				value: '    Oh Deer!', color: 'eb4b4b', app_data: { def_index: '31245' },
			}, {
				value: '    Jolly Jester', color: 'd32ce6', app_data: { def_index: '31243' },
			}, {
				value: '    Merry Cone', color: 'd32ce6', app_data: { def_index: '31247' },
			}, {
				value: '    Hat Chocolate', color: 'd32ce6', app_data: { def_index: '31259' },
			}, {
				value: '    Elf-Made Bandanna', color: '8847ff', app_data: { def_index: '31260' },
			}, {
				value: '    Seasonal Spring', color: '8847ff', app_data: { def_index: '31244' },
			}, {
				value: '    Elf Ignition', color: '8847ff', app_data: { def_index: '31253' },
			}, {
				value: '    Train Of Thought', color: '8847ff', app_data: { def_index: '31254' },
			}, {
				value: '    Seasonal Employee', color: '8847ff', app_data: { def_index: '31258' },
			}, {
				value: '    Reindoonihorns', color: '8847ff', app_data: { def_index: '31249' },
			}, {
				value: '    Festive Cover-Up', color: '4b69ff', app_data: { def_index: '31257' },
			}, {
				value: '    El Fiestibrero', color: '4b69ff', app_data: { def_index: '31241' },
			}, {
				value: '    Ominous Offering', color: '4b69ff', app_data: { def_index: '31251' },
			}, {
				value: '    Brain Cane', color: '4b69ff', app_data: { def_index: '31248' },
			}, {
				value: '    Cozy Catchers', color: '4b69ff', app_data: { def_index: '31250' },
			}, {
				value: '    The Giftcrafter', color: '4b69ff', app_data: { def_index: '31246' },
			}, {
				value: '    Festive Frames', color: '4b69ff', app_data: { def_index: '31252' },
			}, {
				value: '    Mooshanka', color: '4b69ff', app_data: { def_index: '31255' },
			}, {
				value: '    Elf Defense', color: '4b69ff', app_data: { def_index: '31256' },
			}, {
				value: '    Gnome Dome', color: '4b69ff', app_data: { def_index: '31242' },
			}, { value: ' ' }, { value: 'Case Exclusive Bonus Item(s):' }, {
				value: 'Festivizer', color: '6F6A63', app_data: { def_index: '5839' },
			}, { value: ' ' }, { value: 'Case Global Unusual Effect(s)' }, {
				value: '★ Unusual Effect: Green Confetti', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Purple Confetti', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Haunted Ghosts', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Green Energy', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Purple Energy', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Circling TF Logo', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Massed Flies', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Burning Flames', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Scorching Flames', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Searing Plasma', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Vivid Plasma', color: 'ffd700',
			}, { value: '★ Unusual Effect: Sunbeams', color: 'ffd700' }, {
				value: '★ Unusual Effect: Circling Peace Sign', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Circling Heart', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Stormy Storm', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Blizzardy Storm', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Nuts n\' Bolts', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Orbiting Planets', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Orbiting Fire', color: 'ffd700',
				...
				value: '★ Unusual Effect: Dead Presidents', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Miami Nights', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Disco Beat Down', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Smissmas Tree', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Smissmas Tree', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Smissmas Tree', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Hospitable Festivity', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Condescending Embrace', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Condescending Embrace', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Sparkling Spruce', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Glittering Juniper', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Prismatic Pine', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Spiraling Lights', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Spiraling Lights', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Twisting Lights', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Stardust Pathway', color: 'ffd700',
			}, { value: '★ Unusual Effect: Flurry Rush', color: 'ffd700' }, {
				value: '★ Unusual Effect: Spark of Smissmas', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Polar Forecast', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Polar Forecast', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Polar Forecast', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Shining Stag', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Holiday Horns', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Ardent Antlers', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Festive Lights', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Festive Lights', color: 'ffd700',
			}, {
				value: '★ Unusual Effect: Festive Lights', color: 'ffd700',
			}, { value: ' ' }, { value: 'Case Global Bonus Item(s)' }, {
				value: 'Paint Cans!\nTaunt Unusualifiers!\nMvM Tickets!\nAnd TF2 Tools!',
			}, {
	...
	it('Case #20 - Haunted Kraken', () => {
		const econItem = parseEconItem({
			'appid': '440',
			'classid': '5019702566',
			'instanceid': '286161456',
			'icon_url': 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEYYggGXxTjqjx8gMnyMv6NGucF1YNk4cgHiWNqxVUpZLflNGY_dAGSA_laWqw4o1u6XnZh65Y1VYa0puhIOVK4cLUhzmI',
			'icon_url_large': 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEYYggGXxTjqjx8gMnyMv6NGucF1YNk4cgHiWNqxVUpZLflNGY_dAGSA_laWqw4o1u6XnZh65Y1VYa0puhIOVK4cLUhzmI',
			'icon_drag_url': '',
			'name': 'Unusual Airdog',
			'market_hash_name': 'Unusual Airdog',
			'market_name': 'Unusual Airdog',
			'name_color': '8650AC',
			'background_color': '3C352E',
			'type': 'Level 7 Helmet',
			'tradable': 1,
			...
			'market_marketable_restriction': '0',
			'descriptions': [{
				'value': 'Mercenary Grade Helmet', 'color': '4b69ff',
			}, {
				'value': '★ Unusual Effect: Haunted Kraken', 'color': 'ffd700',
			}, {
				'value': '',
			}, {
				'value': ' ',
				...
				'value': 'Mayflower Cosmetics Collection',
			}, {
				'value': '    Bedouin Bandana', 'color': 'eb4b4b', 'app_data': {
					'def_index': '30768',
				},
			}, {
				'value': '    The Dead Head', 'color': 'eb4b4b', 'app_data': {
					'def_index': '30775',
				},
			}, {
				'value': '    The Dayjogger', 'color': 'd32ce6', 'app_data': {
					'def_index': '30779',
				},
			}, {
				'value': '    Dad Duds', 'color': 'd32ce6', 'app_data': {
					'def_index': '30785',
				},
			}, {
				'value': '    Patriot\'s Pouches', 'color': '8847ff', 'app_data': {
					'def_index': '30780',
				},
			}, {
				'value': '    The Lurking Legionnaire', 'color': '8847ff', 'app_data': {
					'def_index': '30777',
				},
			}, {
				'value': '    Gauzed Gaze', 'color': '8847ff', 'app_data': {
					'def_index': '30786',
				},
			}, {
				'value': '    Herald\'s Helm', 'color': '8847ff', 'app_data': {
					'def_index': '30769',
				},
			}, {
				'value': '    Scoped Spartan', 'color': '4b69ff', 'app_data': {
					'def_index': '30789',
				},
			}, {
				'value': '★ The Airdog', 'color': '4b69ff', 'app_data': {
					'def_index': '30767',
				},
			}, {
				'value': '    Squire\'s Sabatons', 'color': '4b69ff', 'app_data': {
					'def_index': '30771',
				},
			}, {
				'value': '    The Surgical Survivalist', 'color': '4b69ff', 'app_data': {
					'def_index': '30773',
				},
			}, {
				'value': '    The Demo\'s Dustcatcher', 'color': '4b69ff', 'app_data': {
					'def_index': '30788',
				},
			}, {
				'value': '    Courtly Cuirass', 'color': '4b69ff', 'app_data': {
					'def_index': '30770',
				},
			}],
			'actions': [{
				'name': 'Item Wiki Page...',
				'link': 'http://wiki.teamfortress.com/scripts/itemredirect.php?id=30767&lang=en_US',
			}, {
				'name': 'Inspect in Game...',
				'link': 'steam://rungame/440/76561202255233023/+tf_econ_item_preview%20S%owner_steamid%A%assetid%D410912148556357555',
			}],
			'market_actions': [{
				'name': 'Inspect in Game...',
				'link': 'steam://rungame/440/76561202255233023/+tf_econ_item_preview%20M%listingid%A%assetid%D410912148556357555',
			}],
			'tags': [{
				'internal_name': 'rarity4',
				'name': 'Unusual',
				...
				'internal_name': 'MayflowerCosmetics_collection',
				'name': 'Mayflower Cosmetics Collection',
				'category': 'Collection',
				'category_name': 'Collection',
			}],
			'app_data': {
				'def_index': '30767', 'quality': '5',
			},
		}, false, false);
		...
		assert.deepEqual(econItem, {
			...
			commodity: true,
			craftable: true,
			fullName: 'Haunted Kraken Airdog',
			id: undefined,
			img: 'https://steamcommunity-a.akamaihd.net/economy/image/fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEYYggGXxTjqjx8gMnyMv6NGucF1YNk4cgHiWNqxVUpZLflNGY_dAGSA_laWqw4o1u6XnZh65Y1VYa0puhIOVK4cLUhzmI/',
			name: 'Airdog',
			parts: [],
			quality: 'Unusual',
			spells: [],
...
describe('Econ Item in Numbers', () => {
	...
	it('Case #9 - Red Rock Roscoe texture', () => {
		...
		const econItem = format.parseEconItem({
			...
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPfflDz5zdwmTVPAPD8ot8Qn-Whg07dR3XcGzuetXKlnpsYuVMbguMYpOGpXZCKTTYAv8uB89iPIIKpDcoyq72Srvaz8UG028HR0ZFYA',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEMaQkUTxr2vTx8mMnvA-aHAfQ_ktk664MayTdinxVwPfflDz5zdwmTVPAPD8ot8Qn-Whg07dR3XcGzuetXKlnpsYuVMbguMYpOGpXZCKTTYAv8uB89iPIIKpDcoyq72Srvaz8UG028HR0ZFYA',
			icon_drag_url: '',
			name: 'Festivized Red Rock Roscoe Pistol',
			market_hash_name: 'Festivized Specialized Killstreak Red Rock Roscoe Pistol (Field-Tested)',
			market_name: 'Festivized Specialized Killstreak Red Rock Roscoe Pistol (Field-Tested)',
			name_color: 'FAFAFA',
			background_color: '3C352E',
			type: '',
			tradable: 1,
			...
			market_marketable_restriction: '0',
			descriptions: [{
				value: 'Elite Grade Pistol (Field-Tested)', color: 'eb4b4b',
			}, {
				value: 'Festivized', color: 'ffd700',
			}, { value: 'Team Colored Decorated Weapon' }, {
				...
				value: 'Killstreaks Active', color: '7ea9d1',
			}, { value: '\'\'Fuzzball\'s Pocket Pistol\'\'' }, { value: ' ' }, { value: ' ' }, { value: 'Concealed Killer Collection' }, {
				value: '    Sand Cannon Rocket Launcher', color: 'eb4b4b', app_data: { def_index: '15014' },
			}, {
				value: '    Red Rock Roscoe Pistol', color: 'eb4b4b', app_data: { def_index: '15013' },
			}, {
				value: '    Psychedelic Slugger Revolver', color: 'd32ce6', app_data: { def_index: '15011' },
			}, {
				value: '    Purple Range Sniper Rifle', color: 'd32ce6', app_data: { def_index: '15007' },
			}, {
				value: '    Sudden Flurry Stickybomb Launcher', color: 'd32ce6', app_data: { def_index: '15009' },
			}, {
				value: '    Night Terror Scattergun', color: '8847ff', app_data: { def_index: '15002' },
			}, {
				value: '    Carpet Bomber Stickybomb Launcher', color: '8847ff', app_data: { def_index: '15012' },
			}, {
				value: '    Woodland Warrior Rocket Launcher', color: '8847ff', app_data: { def_index: '15006' },
			}, {
				value: '    Wrapped Reviver Medi Gun', color: '8847ff', app_data: { def_index: '15010' },
			}, {
				value: '    Night Owl Sniper Rifle', color: '4b69ff', app_data: { def_index: '15000' },
			}, {
				value: '    Woodsy Widowmaker SMG', color: '4b69ff', app_data: { def_index: '15001' },
			}, {
				value: '    Backwoods Boomstick Shotgun', color: '4b69ff', app_data: { def_index: '15003' },
			}, {
				value: '    King of the Jungle Minigun', color: '4b69ff', app_data: { def_index: '15004' },
			}, {
				value: '    Masked Mender Medi Gun', color: '4b69ff', app_data: { def_index: '15008' },
			}, {
				value: '    Forest Fire Flame Thrower', color: '4b69ff', app_data: { def_index: '15005' },
			}],
			actions: [{
				name: 'Item Wiki Page...',
			...
			tags: [{
				...
				internal_name: 'secondary', name: 'Secondary weapon', category: 'Type', category_name: 'Type',
			}, {
				internal_name: 'Scout', name: 'Scout', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Engineer', name: 'Engineer', category: 'Class', category_name: 'Class',
...
describe('Econ item with defindexes', () => {
	...
	it('Case #7', () => {
		const econItem = parseEconItem({
			...
			classid: '638115890',
			instanceid: '0',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEIYwkCSQn3uyxKh8bZBvuYN-wBid0wq8hXjW49lVl_NrC2ZjFjJlPHV6FcDPRj8Am1Cn5i6pE3DIfuoOxReV_x9NyRdNFoUKY',
			...
			market_hash_name: 'Stockbroker\'s Scarf Strangifier Chemistry Set',
			...
			descriptions: [{
				...
				value: 'This is a limited use item. Uses: 1', color: '00a000', app_data: { limited: 1 },
			}],
			actions: [{
				name: 'Item Wiki Page...',
			...
			tags: [{
				...
				internal_name: 'TF_ItemDynamicRecipeTool', name: 'Recipe', category: 'Type', category_name: 'Type',
			}],
	...
	it('Case #14 - bat output', () => {
		...
		const econItem = format.parseEconItem({
			...
			descriptions: [{
				...
				value: 'You will receive all of the following outputs once all of the inputs are fulfilled.',
			}, { value: 'Bat Strangifier', color: '8b8989' }, { value: ' ' }, {
				value: 'This is a limited use item. Uses: 1', color: '00a000', app_data: { limited: 1 },
			}],
			actions: [{
				name: 'Item Wiki Page...',
	...
	it('Case #15 - bat target', () => {
		...
		const econItem = format.parseEconItem({
			...
			descriptions: [{
				...
				value: 'The following are the inputs that must be fulfilled.',
			}, { value: 'Festive Black Box x 198', color: '8b8989' }, { value: ' ' }, {
				value: 'You will receive all of the following outputs once all of the inputs are fulfilled.',
			}, { value: 'Collector\'s Festive Black Box', color: '8b8989' }, { value: ' ' }, {
				value: 'This is a limited use item. Uses: 1', color: '00a000', app_data: { limited: 1 },
			}],
			actions: [{
				name: 'Item Wiki Page...',
	...
	it('Case #17 - Strange Normal', () => {
		const econItem = parseEconItem({
			...
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEcUxQFVBjpoTpMhcrZAfOZBuMInsgK6ZFH3jMlkAQvYOK0NDQyJVSRV_AOWvRo9125CyFlv5NmAoHj8bgHcQ695oLAMK5sbo8uHAbfiA',
			...
			market_hash_name: 'Strange Professional Killstreak Stickybomb Launcher',
			market_name: 'Strange Professional Killstreak Stickybomb Launcher',
			name_color: 'B2B2B2',
			background_color: '3C352E',
			...
			descriptions: [{
				value: '(Damage Dealt: 4195548)', color: '756b5e',
			}, {
			...
			tags: [{
				internal_name: 'Normal', name: 'Normal', category: 'Quality', color: 'B2B2B2', category_name: 'Quality',
			}, {
				internal_name: 'secondary', name: 'Secondary weapon', category: 'Type', category_name: 'Type',
			}, {
				internal_name: 'Demoman', name: 'Demoman', category: 'Class', category_name: 'Class',
		...
		assert.deepEqual(econItem, {
			...
			killstreaker: 'Flames',
			sheen: 'Manndarin',
			parts: ['Damage Dealt', 'Medics Killed That Have Full ÜberCharge', 'Dominations'],
			spells: [],
			marketable: true,
			commodity: false,
		});
	...
	it('Case #18 - Non-Craftable Sticky Jumper', () => {
		const econItem = parseEconItem({
			...
			classid: '9230923',
			instanceid: '11040578',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEIUxQFVBjpoQdJncX2COCzBOESnN97tJFQ3GIyk1V5MbvmZDE-dgGaUaRcCKw-9gu7XXRgsMI7ANHk8usDLBKv6tUEIS3TYQ',
			icon_url_large: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgEIUxQFVBjpoQdJncX2COCzBOESnN97tJFQ3GIyk1V5MbvmZDE-dgGaUaRcCKw-9gu7XXRgsMI7ANHk8usDLBKv6tUEIS3TYQ',
			icon_drag_url: '',
			...
			market_marketable_restriction: '0',
			descriptions: [{
				value: '+200% max secondary ammo on wearer', color: '7ea9d1',
			}, {
				value: 'No self inflicted blast damage taken', color: '7ea9d1',
			}, { value: '-100% damage penalty', color: 'd83636' }, {
				value: 'No random critical hits', color: 'd83636',
			}, { value: '-6 max pipebombs out', color: 'd83636' }, {
				value: 'Wearer cannot carry the intelligence briefcase or PASS Time JACK', color: 'd83636',
			}, {
				value: 'A special no-damage stickybomb launcher for learning stickybomb jump tricks and patterns.',
			}, { value: ' ' }, { value: '( Not Usable in Crafting )' }],
			actions: [{
				name: 'Item Wiki Page...',
	...
	it('Gets uses from Dueling Mini-Game', () => {
		const econItem = parseEconItem({
			...
			classid: '134',
			instanceid: '0',
			icon_url: 'fWFc82js0fmoRAP-qOIPu5THSWqfSmTELLqcUywGkijVjZULUrsm1j-9xgECbwgfYh_3vTRKhs_ZAfOeD-VOmtkzvZRU2GY4wFN_NrHsZWZlJlTGUKILCPc_rFjvXXVg6sI2DYDi9PUWJ1s1TbibCw',
			...
			descriptions: [{
				...
				value: 'This is a limited use item. Uses: 5', color: '00a000', app_data: {
					limited: 1,
				},
			}],
			actions: [{
			...
			tags: [{
				...
				internal_name: 'TF_UsableItem', name: 'Usable Item', category: 'Type', category_name: 'Type',
			}, {
				internal_name: 'Scout', name: 'Scout', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Sniper', name: 'Sniper', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Soldier', name: 'Soldier', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Demoman', name: 'Demoman', category: 'Class', category_name: 'Class',
				...
				internal_name: 'Heavy', name: 'Heavy', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Pyro', name: 'Pyro', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Spy', name: 'Spy', category: 'Class', category_name: 'Class',
			}, {
				internal_name: 'Engineer', name: 'Engineer', category: 'Class', category_name: 'Class',
			}],
			app_data: {
				quantity: '5', def_index: '241', quality: '6',
			},
		}, true, true);
...
describe('Econ item with true defindex', () => {
	...
	describe('Retrieves crate number', () => {
		it('Retrieves crate number correctly for crate', () => {
			...
			}, false, false, { retrieveCrateNumber: true });
		...
		it('Retrieves crate number for non-crate item', () => {
			...
			}, true, true, { retrieveCrateNumber: false });
		...
		it('Retrieves crate number correctly for crate', () => {
			...
			}, false, false, { retrieveCrateNumber: false });
